...
$msg= str_replace(" ","%20","Your payment to $txtloanacno (Installment No. $txtinstno ) has been made on "  . $dts  . " for the amount of Rs. ". $paymentamt. ". Thank You for Payment..");
$ch = curl_init();
...
<tr>
	...
	<td  style="text-align: left;width:30%" >
		<select class="form-control" name="paymenttype" id="paymenttype" onchange="funchkpaymenttype(this.value)" >
...
<tr id="idtrparticularts">
	<th style="width:20%">Particulars</th>
	<td  style="text-align: left;width:30%"  colspan="3" >
	<textarea type="text"  class="form-control" name="ltr_note" id="ltr_note" ></textarea>
	<span id="idcardholder" class="errorclass"></span>
	</td>
</tr>

<tr id="idchqparticularts">
...
?>
<script>
function funchkpaymenttype(paymenttype)
{
	//idchqparticularts
	if(paymenttype=="Cheque")
	{
		document.getElementById('idchqparticularts').innerHTML='<th>Cheque No.</th><td style="text-align: left;"><input type="text"  class="form-control" name="ltr_chqno" id="ltr_chqno" ><span id="idltr_chqno" class="errorclass"></span></td><th>Bank Detail</th>	<td style="text-align: left;"><input type="text"  class="form-control" name="ltr_bank" id="ltr_bank"><span id="idltr_bank" class="errorclass"></td>';
	}
	else
	{
		document.getElementById('idchqparticularts').innerHTML='<input type="hidden"  class="form-control" name="ltr_chqno" id="ltr_chqno" value=" " ><input type="hidden"  class="form-control" name="ltr_bank" id="ltr_bank" value=" "></td>';
