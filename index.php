...
<div class="banner-info">
        ...
        <div class="container py-md-5">
            <div class="row bottom-grids text-center">
                ...
                <div class="col-md-4 mt-md-0 mt-5 bottom-grid">
                    ...
                    <p class="mt-4">AGH Loans offers personal loans over flexible tenors of 12 months to 60 months.</p>
                </div>
    ...
    <section class="products py-5" id="stats">
        <div class="container py-lg-5 py-3">
            <h3 class="title-w3ls mb-sm-6 mb-6 text-center"> Number of Loan Applications</h3>
            <div class="row products_grids text-center mt-5">

<?php
		$sql = "SELECT * FROM  ltyp_loantypes WHERE ltyp_status	='Active' order by RAND() LIMIT 3";
...
?>	
<div class="col-lg-4 col-4 grid4">
	<div class="prodct1">
		<a href="#">
...
<div class="col-lg-7 welcome-right text-center mt-lg-0 mt-5">
    ...
    <section class="news-letter-w3-pvt" style="background-color:powderblue;" >
        <div class="container contact-form mx-auto text-left">
            <h3 class="title-w3ls two text-left mb-5">Take instant loans @ AGH </h3>
            <form method="post" action="#" class="w3pvt-frm">
                <div class="row subscribe-sec">
                    <p class="news-para col-lg-12">Take instant loans whenever you need, 24x7. You can get instant cash loans from AGH Loans and also a credit card.</p>
                </div>
	...
	<div class="serve-grid test-gd mt-4">
		...
		<p class="mt-2"><?php echo $cstname[5]; ?> </p>
                ...
                <div class="col-lg-5 welcome-left pl-lg-5">
                    ...
                    <p class="mt-4 test"><span class="fa fa-quote-left"></span>Before 4 years ago, purchased my loan from AGH Loans. Due to the low interest rates, i have selected AGH Housing. Taken the loan amount of Rs. 14 lakhs and i am paying the EMI amount of Rs. 12940 per month. Total duration of the loan is 15 years.</p>
                    ...
                    <p class="mt-4 test"><span class="fa fa-quote-left"></span> I got an offer for personal loan from AGH Loans. I used the loan for investment and the loan was sanctioned on time.The tenure of the loan were 3 years and its almost complete.The overall experience with the personal loan were fine.</p>
