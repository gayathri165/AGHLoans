...
<div class="row">
	...
	<div class="col-md-9">
		<input type="text" name="lacc_loanamt" id="lacc_loanamt" class="form-control" value="<?php echo  $rsedit['lacc_loanamt']; ?>">
	</div>
</div>
<br>
<div class="row">
	...
	<div class="col-md-9">
		<input type="text" name="lacc_intrate" id="lacc_intrate" class="form-control" value="<?php echo  $rsedit['lacc_intrate']; ?>">
	</div>
</div>
<br>
<div class="row">
	...
	<div class="col-md-9">
		<input type="text" name="lacc_tenor" id="lacc_tenor" class="form-control" value="<?php echo  $rsedit['lacc_tenor']; ?>">
	</div>
</div>
<br>
...
<div class="read-icon">
	<center><a href="fun3.php" class="btn btn-danger">Update Profile</a></center>
</div>
                        </div>
                    </div>
                </div>
