...
<br>
 <h3 class="title-w3ls mb-sm-1 mb-4 text-center"> View Terminated Loan Applications</h3>
...
?>	
		...
		<tbody>
			...
			$sql = $sql . " AND lacc_status='Active' ";
			if(isset($_SESSION['cst_id']))
			{
			...
			while($rs = mysqli_fetch_array($qsql))
			{
				...
				echo "<tr>
						...
						<td><b>$rs[lacc_custname]</b><br>
						<b>DOB</b> - ".  date("d-M-Y",strtotime($rs['lacc_dob'])) . "<br>
						<b>PAN</b> -  $rs[lacc_pan]
						</td>
...
{						
	...
	echo "<a href='loanaccountchart.php?lacc_id=$rs[0]' class='btn btn-primary' >View <br>Application</a>";
	echo "</td>";
}
if(isset($_SESSION['cst_id']))
{
	echo "<td style='width: 50px;'>";
	echo "<a href='loanaccountchart.php?lacc_id=$rs[0]' class='btn btn-primary' >View Loan Chart</a>";
	echo "</td>";
}
/*						
